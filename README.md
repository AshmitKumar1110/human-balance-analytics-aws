...
## ⚙️ AWS Glue Configuration

The Glue job scripts use a configurable `S3_BUCKET` job parameter instead of hard-coding an environment-specific bucket name.

For each Glue job, add the job parameter:

```text
--S3_BUCKET <your-s3-bucket-name>
```

The scripts then use paths such as `s3://<your-s3-bucket-name>/customer/landing/` and `s3://<your-s3-bucket-name>/step_trainer/curated/`.
...
- GitHub: https://github.com/AshmitKumar1110
- LinkedIn: https://www.linkedin.com/in/ashmit-kumar-89518422b/
